...
Commit `7eedc897d` changes both dependency walks to iterative post-order and adds a 2,048-node regression in `test-meta-split`. It does not alter tensor-split results or model math.
...
```bash
cd /home/edwin/llama.cpp-rdna2-laguna-fix
