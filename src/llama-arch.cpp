...
static const std::map<llm_arch, const char *> LLM_ARCH_NAMES = {
    ...
    { LLM_ARCH_DEEPSEEK4_DSPARK_DRAFT, "deepseek_v4_flash_dspark_draft" },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_DSPARK_NORM,                           "dspark.norm" },
    { LLM_TENSOR_DSPARK_MARKOV_W1_OFFICIAL,             "dspark.markov_w1" },
    { LLM_TENSOR_DSPARK_MARKOV_W2_OFFICIAL,             "dspark.markov_w2" },
    { LLM_TENSOR_DSPARK_HC_HEAD_FN_OFFICIAL,            "dspark.hc_head_fn" },
    { LLM_TENSOR_DSPARK_HC_HEAD_BASE_OFFICIAL,          "dspark.hc_head_base" },
    { LLM_TENSOR_DSPARK_HC_HEAD_SCALE_OFFICIAL,         "dspark.hc_head_scale" },
    { LLM_TENSOR_DSPARK_ATTN_SINKS,                     "dspark.%d.attn_sinks" },
    { LLM_TENSOR_DSPARK_ATTN_NORM,                      "dspark.%d.attn_norm" },
    { LLM_TENSOR_DSPARK_FFN_NORM,                       "dspark.%d.ffn_norm" },
    { LLM_TENSOR_DSPARK_ATTN_Q_A_NORM,                  "dspark.%d.attn_q_a_norm" },
    { LLM_TENSOR_DSPARK_ATTN_KV_A_NORM,                 "dspark.%d.attn_kv_a_norm" },
    { LLM_TENSOR_DSPARK_ATTN_Q_A,                       "dspark.%d.attn_q_a" },
    { LLM_TENSOR_DSPARK_ATTN_Q_B,                       "dspark.%d.attn_q_b" },
    { LLM_TENSOR_DSPARK_ATTN_KV,                        "dspark.%d.attn_kv" },
    { LLM_TENSOR_DSPARK_ATTN_OUT_A,                     "dspark.%d.attn_output_a" },
    { LLM_TENSOR_DSPARK_ATTN_OUT_B,                     "dspark.%d.attn_output_b" },
    { LLM_TENSOR_DSPARK_HC_ATTN_FN,                     "dspark.%d.hc_attn_fn" },
    { LLM_TENSOR_DSPARK_HC_ATTN_BASE,                   "dspark.%d.hc_attn_base" },
    { LLM_TENSOR_DSPARK_HC_ATTN_SCALE,                  "dspark.%d.hc_attn_scale" },
    { LLM_TENSOR_DSPARK_HC_FFN_FN,                      "dspark.%d.hc_ffn_fn" },
    { LLM_TENSOR_DSPARK_HC_FFN_BASE,                    "dspark.%d.hc_ffn_base" },
    { LLM_TENSOR_DSPARK_HC_FFN_SCALE,                   "dspark.%d.hc_ffn_scale" },
    { LLM_TENSOR_DSPARK_FFN_GATE_INP,                   "dspark.%d.ffn_gate_inp" },
    { LLM_TENSOR_DSPARK_EXP_PROBS_B,                    "dspark.%d.exp_probs_b" },
    { LLM_TENSOR_DSPARK_FFN_GATE_EXPS,                  "dspark.%d.ffn_gate_exps" },
    { LLM_TENSOR_DSPARK_FFN_UP_EXPS,                    "dspark.%d.ffn_up_exps" },
    { LLM_TENSOR_DSPARK_FFN_DOWN_EXPS,                  "dspark.%d.ffn_down_exps" },
    { LLM_TENSOR_DSPARK_FFN_GATE_SHEXP,                 "dspark.%d.ffn_gate_shexp" },
    { LLM_TENSOR_DSPARK_FFN_UP_SHEXP,                   "dspark.%d.ffn_up_shexp" },
    { LLM_TENSOR_DSPARK_FFN_DOWN_SHEXP,                 "dspark.%d.ffn_down_shexp" },
};
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_DSPARK_NORM,               {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL}},
    {LLM_TENSOR_DSPARK_MARKOV_W1_OFFICIAL, {LLM_TENSOR_LAYER_OUTPUT,   GGML_OP_GET_ROWS}},
    {LLM_TENSOR_DSPARK_MARKOV_W2_OFFICIAL, {LLM_TENSOR_LAYER_OUTPUT,   GGML_OP_MUL_MAT}},
    {LLM_TENSOR_DSPARK_HC_HEAD_FN_OFFICIAL,{LLM_TENSOR_LAYER_OUTPUT,   GGML_OP_MUL_MAT}},
    {LLM_TENSOR_DSPARK_HC_HEAD_BASE_OFFICIAL,{LLM_TENSOR_LAYER_OUTPUT, GGML_OP_ADD}},
    {LLM_TENSOR_DSPARK_HC_HEAD_SCALE_OFFICIAL,{LLM_TENSOR_LAYER_OUTPUT,GGML_OP_MUL}},
    {LLM_TENSOR_DSPARK_ATTN_SINKS, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_DSPARK_ATTN_NORM, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_DSPARK_FFN_NORM, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_DSPARK_ATTN_Q_A_NORM, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_DSPARK_ATTN_KV_A_NORM, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_DSPARK_ATTN_Q_A, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_DSPARK_ATTN_Q_B, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_DSPARK_ATTN_KV, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_DSPARK_ATTN_OUT_A, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_DSPARK_ATTN_OUT_B, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_DSPARK_HC_ATTN_FN, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_DSPARK_HC_ATTN_BASE, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_ADD}},
    {LLM_TENSOR_DSPARK_HC_ATTN_SCALE, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_DSPARK_HC_FFN_FN, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_DSPARK_HC_FFN_BASE, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_ADD}},
    {LLM_TENSOR_DSPARK_HC_FFN_SCALE, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_DSPARK_FFN_GATE_INP, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_DSPARK_EXP_PROBS_B, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_ADD}},
    {LLM_TENSOR_DSPARK_FFN_GATE_EXPS, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_DSPARK_FFN_UP_EXPS, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_DSPARK_FFN_DOWN_EXPS, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_DSPARK_FFN_GATE_SHEXP, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_DSPARK_FFN_UP_SHEXP, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_DSPARK_FFN_DOWN_SHEXP, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
};
