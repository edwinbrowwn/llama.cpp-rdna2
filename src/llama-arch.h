...
enum llm_arch {
    ...
    LLM_ARCH_DEEPSEEK32,
    LLM_ARCH_DEEPSEEK4,
    LLM_ARCH_DEEPSEEK4_DSPARK_DRAFT,
    LLM_ARCH_CHATGLM,
    LLM_ARCH_GLM4,
    LLM_ARCH_GLM4_MOE,
    LLM_ARCH_GLM_DSA,
...
enum llm_tensor {
    ...
    // Official DeepSeek-V4 DSpark drafter confidence head.
    LLM_TENSOR_DSPARK_CONFIDENCE_HEAD,
    LLM_TENSOR_DSPARK_MAIN_PROJ,
    LLM_TENSOR_DSPARK_MAIN_NORM,
    LLM_TENSOR_DSPARK_NORM,
    LLM_TENSOR_DSPARK_MARKOV_W1_OFFICIAL,
    LLM_TENSOR_DSPARK_MARKOV_W2_OFFICIAL,
    LLM_TENSOR_DSPARK_HC_HEAD_FN_OFFICIAL,
    LLM_TENSOR_DSPARK_HC_HEAD_BASE_OFFICIAL,
    LLM_TENSOR_DSPARK_HC_HEAD_SCALE_OFFICIAL,
    LLM_TENSOR_DSPARK_ATTN_SINKS,
    LLM_TENSOR_DSPARK_ATTN_NORM,
    LLM_TENSOR_DSPARK_FFN_NORM,
    LLM_TENSOR_DSPARK_ATTN_Q_A_NORM,
    LLM_TENSOR_DSPARK_ATTN_KV_A_NORM,
    LLM_TENSOR_DSPARK_ATTN_Q_A,
    LLM_TENSOR_DSPARK_ATTN_Q_B,
    LLM_TENSOR_DSPARK_ATTN_KV,
    LLM_TENSOR_DSPARK_ATTN_OUT_A,
    LLM_TENSOR_DSPARK_ATTN_OUT_B,
    LLM_TENSOR_DSPARK_HC_ATTN_FN,
    LLM_TENSOR_DSPARK_HC_ATTN_BASE,
    LLM_TENSOR_DSPARK_HC_ATTN_SCALE,
    LLM_TENSOR_DSPARK_HC_FFN_FN,
    LLM_TENSOR_DSPARK_HC_FFN_BASE,
    LLM_TENSOR_DSPARK_HC_FFN_SCALE,
    LLM_TENSOR_DSPARK_FFN_GATE_INP,
    LLM_TENSOR_DSPARK_EXP_PROBS_B,
    LLM_TENSOR_DSPARK_FFN_GATE_EXPS,
    LLM_TENSOR_DSPARK_FFN_UP_EXPS,
    LLM_TENSOR_DSPARK_FFN_DOWN_EXPS,
    LLM_TENSOR_DSPARK_FFN_GATE_SHEXP,
    LLM_TENSOR_DSPARK_FFN_UP_SHEXP,
    LLM_TENSOR_DSPARK_FFN_DOWN_SHEXP,
};
