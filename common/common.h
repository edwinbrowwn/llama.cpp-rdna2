...
struct common_params {
    ...
    float   tensor_split[128]  = {0};   // TP weights in hybrid mode; legacy device split otherwise
    uint32_t tp_size           = 0;     // uniform TP group size; 0 preserves legacy derivation
    uint32_t pp_size           = 1;     // number of pipeline stages; <= 1 disables hybrid mode
    float   pp_split[128]      = {0};   // complete-layer weights among PP stages
