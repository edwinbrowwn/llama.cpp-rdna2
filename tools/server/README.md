...
| `--spec-draft-model, -md, --model-draft FNAME` | draft model for speculative decoding; with `SPEC_SIDECAR=1`, supported DFlash/Qwen4Exp GGUFs are automatically converted to cached provider assets (default: unused)<br/>(env: LLAMA_ARG_SPEC_DRAFT_MODEL) |
